...
public class BCryptPasswordEncoderImpl extends BCryptPasswordEncoder {
    ...
    public BCryptPasswordEncoderImpl(BCryptPasswordEncoder.BCryptVersion version) {
        this(version, (SecureRandom)null);
    }

    public BCryptPasswordEncoderImpl(BCryptPasswordEncoder.BCryptVersion version, SecureRandom random) {
    ...
    public BCryptPasswordEncoderImpl(BCryptPasswordEncoder.BCryptVersion version, int strength) {
        this(version, strength, (SecureRandom)null);
    }

    public BCryptPasswordEncoderImpl(BCryptPasswordEncoder.BCryptVersion version, int strength, SecureRandom random) {
